...
export const DateListFilter: FC<Props> = ({ index }) => {
				...
				render={({ field, fieldState: { error } }) => (
					<FormControl fullWidth sx={{ maxWidth: 170 }}>
						...
						<Select
							...
							label='Условие'
						>
							<MenuItem key='dl_eq' value='l_eq'>
								Равна
							</MenuItem>
							<MenuItem key='dl_gte' value='l_gte'>
								Больше или равна
							</MenuItem>
							<MenuItem key='dl_lte' value='l_lte'>
								Меньше или равна
							</MenuItem>
							<MenuItem key='dl_empty' value='null'>
								Не заполнена
							</MenuItem>
						</Select>
					</FormControl>
